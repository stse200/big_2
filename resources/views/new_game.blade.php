...
/* Check Box */
/* Customize the label (the scoring_box) */
.scoring_box {
  display: block;
  position: relative;
  padding-left: 35px;
...
.scoring_box:hover input ~ .checkmark {
  background-color: #2196F3;
}

/* When the checkbox is checked, add a blue background */
.scoring_box input:checked ~ .checkmark {
  background-color: #2196F3;
}
...
.scoring_box input:checked ~ .checkmark:after {
  display: block;
}

/* Style the checkmark/indicator */
.scoring_box .checkmark:after {
  left: 9px;
  top: 2px;
  width: 9px;
  height: 17px;
